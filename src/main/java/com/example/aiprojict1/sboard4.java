...
public class sboard4 implements Initializable {

    public double it4= homepage.ith();
    public double cr4=homepage.crh();
    public double ft4=homepage.fth();
    ...
    void startButtonClick(ActionEvent event) {
        cleanChessBoard();
        NQueensSimulatedAnnealing solver =  new NQueensSimulatedAnnealing(4,it4,cr4,ft4);
    ...
    @FXML
    void genrate4(MouseEvent event) {
  //  NQueensSimulatedAnnealing solver =  new NQueensSimulatedAnnealing(4,it4,cr4,ft4);
