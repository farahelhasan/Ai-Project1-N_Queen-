...
public class sboard7 implements Initializable {
    public double it7= homepage.ith();
    public double cr7=homepage.crh();
    public double ft7=homepage.fth();
    @FXML
    ...
    void startButtonClick(ActionEvent event) {
        cleanChessBoard();
        NQueensSimulatedAnnealing solver =  new NQueensSimulatedAnnealing(7,it7,cr7,ft7);
    ...
    @FXML
    void genrate7(MouseEvent event) {
        cleanChessBoard();
