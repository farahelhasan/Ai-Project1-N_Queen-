...
public class sboard6 implements Initializable {
    public double it6= homepage.ith();
    public double cr6=homepage.crh();
    public double ft6=homepage.fth();
    @FXML
    ...
    void startButtonClick(ActionEvent event) {
        cleanChessBoard();
        NQueensSimulatedAnnealing solver =  new NQueensSimulatedAnnealing(6,it6,cr6,ft6);
    ...
    @FXML
    void genrate6(MouseEvent event) {
        cleanChessBoard();
